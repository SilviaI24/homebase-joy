-- Fix urgente: la migración simplificar_publicacion_dos_opciones acababa de
-- reemplazar dashboard_inmuebles_stats() con una copia que perdía el fix de
-- 20260820105419 (unaccent() sin cualificar falla con SET search_path='').
-- Restaura public.unaccent() y mantiene el cambio de prospectosPendientes.
