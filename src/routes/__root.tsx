...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "El Sol Grupo CRM — gestión inmobiliaria de propiedades, clientes y visitas.",
      },
      { name: "author", content: "El Sol Grupo" },
    ...
    links: [
      ...
      // Favicon: monograma "ES" ya usado en AppShell (UX-07).
