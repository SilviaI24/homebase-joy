...
import { listAlquileres, type Inmueble } from "@/lib/inmuebles.functions";
...
function statusBadge(estatus: string) {
  const map: Record<string, string> = {
    ...
    Alquilado: "bg-purple-500/15 text-purple-600 dark:text-purple-400",
  };
            ...
            <div className="p-4 flex flex-col gap-2 flex-1">
              <div className="flex items-baseline justify-between gap-2">
                ...
                <div className="text-base font-semibold text-primary whitespace-nowrap">
                  {formatEuro(i.precio)}<span className="text-[11px] font-normal text-muted-foreground">/mes</span>
                </div>
              </div>
